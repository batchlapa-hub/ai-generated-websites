...
document.addEventListener('DOMContentLoaded', () => {
  ...
  faqItems.forEach(item => {
    ...
    if (summary) {
      summary.addEventListener('click', () => {
        // Close all other open FAQs in the same parent container
  ...
  // Optional Enhancement: Auto-rotation for Testimonial Grid (3+ items)
      ...
      if (testimonials[currentIndex]) {
        ...
        setTimeout(() => {
          ...
          if (testimonials[currentIndex]) {
            ...
            // Optional: Add a subtle transition class or style manipulation here
            // depending on your existing CSS setup for transitions
          }
